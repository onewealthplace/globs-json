...
public class JsonGlobTypeWriter {
   ...
   public static void write(GlobTypeToJsonName globTypeToJsonName, JsonGenerator jsonGenerator, GlobType globType) {
      new JsonGlobTypeWriter(globTypeToJsonName, jsonGenerator).write(globType);
   }
